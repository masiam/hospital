...
const About = () => {
    ...
    viewport={{once: true}}
      ...
      <h1 className='text-2xl sm:text-4x1 font-bold mb-2'>
        About <span className='underline underline-offset-4 decoration-1 under font-light'>Our Brand</span></h1>
         ...
         <div className='flex flex-col items-center md:items-start mt-10 text-grey-600'>
            ...
            <p className='my-10 max-w-lg'>Where Modern Medical Excellence Meets the Warmth of Personalized Care to Restore Your Health and Well-Being.</p>
